...
class ActiveProposalShowScreen extends StatefulWidget {
  const ActiveProposalShowScreen({Key? key});

  @override
  State<ActiveProposalShowScreen> createState() =>
      _ActiveProposalShowState();
}

class _ActiveProposalShowState
    extends State<ActiveProposalShowScreen> {
  Uuid uuid = Uuid();
